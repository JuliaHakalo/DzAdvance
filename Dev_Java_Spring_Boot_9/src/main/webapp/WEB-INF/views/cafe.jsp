			...
			<div>
				<ul class="navbar-nav">
					...
					<sec:authorize access="isAuthenticated()">
						<li class="nav-item"><a
							class="nav-link; btn btn-outline-primary" href="/profile"><span
		...
		<div class="row">
			<div class="col-12">
				<form:form action="/cafe" method="GET" modelAttribute="cafeFilter">
					...
					<div class="col-6">
						<form:input class="form-control" path="searchName"
		...
		<div class="container mb-2 mt-2 ">
			<div class="row justify-content-center">
				...
				<div class="col-lg-8 col-sm-12">
					<div class="card"
						onclick="window.location.href='/cafe/${cafe.id}'; return false"
						onmouseover="this.style.backgroundColor='#c1fbff';"
