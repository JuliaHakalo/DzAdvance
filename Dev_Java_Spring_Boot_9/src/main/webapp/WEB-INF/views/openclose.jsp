					...
					<c:forEach var="cuisine" items="${cuisines.content}">
						<tr>
							...
							<td class="text-center">
								<a href="/admin/cuisine/update/${cuisine.id}<custom:/>" class="btn btn-outline-warning btn-sm">Update</a>
...
<body>
	<div class="container">
		<div class="row">
			<div class="col-3">
				<form:form action="/admin/openclose" method="GET" modelAttribute="filter">
					<div class="form-group row">
						<div class="col-12">
			...
			<div class="col-9">
				<form:form action="/admin/openclose" method="POST" modelAttribute="openclose">
					...
					<div class="form-group row">
						<div class="col-10 ml-auto">
							<button class="btn btn-sm btn-outline-success">Save</button>
							<a href="/admin/openclose/cancel<custom:allParams/>" class="btn btn-sm btn-outline-warning">Cancel</a>
						</div>
					</div>
				</form:form>
			</div>
		...
		<div class="row">
			<div class="col-9">
				<table class="table table-bordered">
					...
					<c:forEach var="openclose" items="${opencloses.content}">
						<tr>
							<td>${openclose.time}</td>
							<td class="text-center">
								<a href="/admin/openclose/update/${openclose.id}<custom:allParams/>" class="btn btn-outline-warning btn-sm">Update</a>
								<a href="/admin/openclose/delete/${openclose.id}<custom:allParams/>" class="btn btn-outline-danger btn-sm">Delete</a>
							</td>
						</tr>
					</c:forEach>
				</table>
			...
			<div class="col-3">
				<div class="row">
					...
					<div class="col-6 text-center">
						<custom:size posibleSizes="1,2,5,10" size="${opencloses.size}" />
					</div>
				</div>
			</div>
		</div>
